...
# 
#  You will initially start at the upper left cell (0,0). A valid path in the gr
# id is a path which starts from the upper left cell (0,0) and ends at the bottom-
# right cell (m - 1, n - 1) following the signs on the grid. The valid path doesn'
# t have to be the shortest. 
# 
...
# The path to (3, 3) is as follows. (0, 0) --> (0, 1) --> (0, 2) --> (0, 3) chan
# ge the arrow to down with cost = 1 --> (1, 3) --> (1, 2) --> (1, 1) --> (1, 0) c
# hange the arrow to down with cost = 1 --> (2, 0) --> (2, 1) --> (2, 2) --> (2, 3
